...
class PopularTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(PopularMovieCell.self, forCellReuseIdentifier: "cellid")
    }
    
    func downloadJSON(completed: @escaping() -> () ) {
        let url = URL(string: MovieURLPrefix+"popular?api_key="+APIKey)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = PopularMovieCell(style: .default, reuseIdentifier: "cellid")
    ...
    @objc func handlefav(sender: UIButton) {
        ...
        let ref = Database.database().reference()
        let currentCell = sender.superview?.superview as! PopularMovieCell
