...
class NowPlayingTableViewController: UITableViewController {
    var results: MovieResults? //general movie data
    var reviews: Reviews?
    override func viewDidLoad() {
        ...
        tableView.register(NowPlayingMovieCell.self, forCellReuseIdentifier: "cellid")
    }
    //downloads from the json data
    func downloadJSON(completed: @escaping() -> () ) {
        let url = URL(string: MovieURLPrefix+"now_playing?api_key="+APIKey)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = NowPlayingMovieCell(style: .default, reuseIdentifier: "cellid")
    ...
    @objc func handlefav(sender: UIButton) {
        ...
        let ref = Database.database().reference()
        let currentCell = sender.superview?.superview as! NowPlayingMovieCell
