...
class NowPlayingMovieCell: UITableViewCell {
    var link: NowPlayingTableViewController?
    //a label for the movie title
    ...
    //setup up the views to show the movie poster correctly
