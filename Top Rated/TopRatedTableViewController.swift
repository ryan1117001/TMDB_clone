...
class TopRatedTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(TopRatedMovieCell.self, forCellReuseIdentifier: "cellid")
    }
    
    func downloadJSON(completed: @escaping() -> () ) {
        let url = URL(string: MovieURLPrefix+"top_rated?api_key="+APIKey)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = TopRatedMovieCell(style: .default, reuseIdentifier: "cellid")
    ...
    @objc func handlefav(sender: UIButton) {
        ...
        let ref = Database.database().reference()
        let currentCell = sender.superview?.superview as! TopRatedMovieCell
